  ...
  <main class="container mx-auto px-4 py-8">
    ...
    <section>
      <div class="bg-white shadow-md rounded-lg overflow-hidden max-w-lg mx-auto p-6 text-center">
        ...
        <div class="space-y-4">
          <a href="products/" class="block bg-indigo-500 text-white py-2 px-4 rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">商品一覧に戻る</a>
