    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden p-6">
      ...
      <form action="register/add.php" method="POST" class="space-y-4">
        ...
        <div class="flex justify-between">
          ...
          <button type="submit" class="bg-indigo-500 text-white py-2 px-4 rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">登録する</button>
        </div>
      </form>
    </div>
  </main>
